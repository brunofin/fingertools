...
class Texto(FTObject):
	...
	text = models.CharField(max_length=5242880)
	language = models.CharField(max_length=30, choices=LANGUAGE_CHOICES)
	titulo = models.CharField(max_length=50)
	expires = models.PositiveIntegerField(choices=EXPIRES_CHOICES)
	exposure = models.PositiveIntegerField(choices=EXPOSURE_CHOICES)
	
	def url(self):
		return '/t/' + str(self.id) + '/d'
